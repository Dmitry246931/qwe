      ...
      <div class="container">
          <div class="row">
              <form  method="GET">
                  ...
                  <p style="position: relative; text-align: center;">Фильтрация по акции:</p>

                  <div class="" >
                      <select name="shares_share" class="form-control" >
                          <option ></option>
                          <option value="20%" <?php if ($_GET['shares_share'] == '20%') { ?>selected="selected" <?php };?>>20%</option >
                          <option value="30%" <?php if ($_GET['shares_share'] == '30%') { ?>selected="selected" <?php };?>>30%</option>
                          <option value="40%" <?php if ($_GET['shares_share'] == '40%') { ?>selected="selected" <?php };?>>40%</option>
                          <option value="50%" <?php if ($_GET['shares_share'] == '50%') { ?>selected="selected" <?php };?>>50%</option>
                          <option value="90%" <?php if ($_GET['shares_share'] == '90%') { ?>selected="selected" <?php };?>>90%</option>
                      </select>
                  ...
                  <div class="input-group">
                      ...
                      <textarea class="form-control" name="description" placeholder="Введите описание товара:" value="<?=$_GET['description']; ?>"></textarea>
                  </div>

                  <p style="position: relative; text-align: center;">Фильтрация по наименованию:</p>

                  <input class="mb-2 form-control me-2" name="monitors_name" type="text" placeholder="Введите наименование товара:"  value="<?= $_GET['monitors_name']; ?>">
                  <button name="FIlterOn" value="Применить фильтр" class="btn btn-primary mt-3 me-3 btn-sm" style="display:bloc; margin: 0 auto;">Применить фильтр</button>
                  <button name="FIlterOff" value="Очистить фильтр" class="btn btn-danger mt-3 btn-sm">Очистить фильтр</button>
              </form>
          </div>
      </div>
        ...
        <table>
          ...
          <tr>
              <th scope="row"><img src="image_2/<?=$mon['img_path'] ?>" style="max-width:150px;"></th>
              <td><?= htmlspecialchars($mon['monitors_name'])?></td>
              <td><?= htmlspecialchars($mon['shares_share'])?></td>
              <td><?= htmlspecialchars($mon['description'])?></td>
              <td><?= htmlspecialchars($mon['cost'])?></td>
          </tr>
        <?php endforeach;?>
        </table>
