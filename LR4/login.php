...
<html lang="ru">
  ...
  <body >
      ...
      <div class="col-md-5 mx-auto" style="position: relative; width: 400px; height: 300px; background-color: #f5f5f5;  border: 2px solid #ced4da; border-radius: 6px; margin-top: 50px;">
          <div class="row">
              <div class=""></div>
              <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" style="width: 350px; display: block; margin-left: auto; margin-right: auto; margin-top: 15px; ">
                  <div class="form-group" style="margin-bottom: 1rem; ">
                      <label for="login" style="margin-left: auto;">Email (Логин)</label>
                      <input type="email" name="login" id="login"  class="form-control" placeholder="example@example.com" >
                  </div>
                  ...
                  <div class="col-md-12 " style="">
                      <button type="submit" name="button">Войти</button>
                          <a href="signup.php" style=" color: #212529; position: relative; display: block; margin-left: auto; margin-right: auto; text-align: center; margin-top: 5px;"> Зарегистрироваться</a>
                  </div>
                  <p><?php
