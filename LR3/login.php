          ...
          <div class="row">
              ...
              <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" style="width: 350px; display: block; margin-left: auto; margin-right: auto; margin-top: 15px; ">
                  <div class="form-group" style="margin-bottom: 1rem; ">
                      ...
                      <input type="login" name="login" id="login"  class="form-control" placeholder="example@example.com" >
                  </div>
                  ...
                  <div class="col-md-12 " style="">
                      <button type="submit" name="button">Войти</button>
                          <a href="signup.php" style=" color: #212529; position: relative; display: block; margin-left: auto; margin-right: auto; text-align: center; margin-top: 5px;"> Зарегестрироваться</a>
                  </div>
                  <p><?php
