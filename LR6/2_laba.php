              ...
              <form  method="GET">
                  ...
                  <div class="" >
                      <select name="shares_share" class="form-control" >
                          <option ></option>
                          <option value="10%" <?php if ($_GET['shares_share'] == '10%') { ?>selected="selected" <?php };?>>10%</option >
                  ...
                  <button name="FIlterOn" value="Применить фильтр" class="btn btn-primary mt-3 me-3 btn-sm">Применить фильтр</button>
